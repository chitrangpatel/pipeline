...
import (
	...
	step "github.com/tektoncd/pipeline/pkg/client/injection/informers/v1/steps/step"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "step-controller"
	defaultFinalizerName       = "steps.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	stepInformer := step.Get(ctx)

	lister := stepInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.Step"),
	)
