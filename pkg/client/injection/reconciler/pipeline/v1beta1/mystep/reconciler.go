...
// controller reconciling v1beta1.MyStep.
type Interface interface {
	// ReconcileKind implements custom logic to reconcile v1beta1.MyStep. Any changes
	// to the objects .Status or .Finalizers will be propagated to the stored
	// object. It is recommended that implementors do not call any update calls
	// for the Kind inside of ReconcileKind, it is the responsibility of the calling
	// controller to propagate those properties. The resource passed to ReconcileKind
	// will always have an empty deletion timestamp.
	ReconcileKind(ctx context.Context, o *v1beta1.MyStep) reconciler.Event
}

// Finalizer defines the strongly typed interfaces to be implemented by a
// controller finalizing v1beta1.MyStep.
type Finalizer interface {
	// FinalizeKind implements custom logic to finalize v1beta1.MyStep. Any changes
	...
	// deletion timestamp.
	FinalizeKind(ctx context.Context, o *v1beta1.MyStep) reconciler.Event
}

// ReadOnlyInterface defines the strongly typed interfaces to be implemented by a
// controller reconciling v1beta1.MyStep if they want to process resources for which
// they are not the leader.
type ReadOnlyInterface interface {
	// ObserveKind implements logic to observe v1beta1.MyStep.
	// This method should not write to the API.
	ObserveKind(ctx context.Context, o *v1beta1.MyStep) reconciler.Event
}

type doReconcile func(ctx context.Context, o *v1beta1.MyStep) reconciler.Event

// reconcilerImpl implements controller.Reconciler for v1beta1.MyStep resources.
type reconcilerImpl struct {
	...
	Lister pipelinev1beta1.MyStepLister
...
func NewReconciler(ctx context.Context, logger *zap.SugaredLogger, client versioned.Interface, lister pipelinev1beta1.MyStepLister, recorder record.EventRecorder, r Interface, options ...controller.Options) controller.Reconciler {
...
func (r *reconcilerImpl) Reconcile(ctx context.Context, key string) error {
	...
	getter := r.Lister.MySteps(s.namespace)
...
func (r *reconcilerImpl) updateFinalizersFiltered(ctx context.Context, resource *v1beta1.MyStep, desiredFinalizers sets.String) (*v1beta1.MyStep, error) {
	// Don't modify the informers copy.
	...
	patcher := r.Client.TektonV1beta1().MySteps(resource.Namespace)
...
func (r *reconcilerImpl) setFinalizerIfFinalizer(ctx context.Context, resource *v1beta1.MyStep) (*v1beta1.MyStep, error) {
...
func (r *reconcilerImpl) clearFinalizer(ctx context.Context, resource *v1beta1.MyStep, reconcileEvent reconciler.Event) (*v1beta1.MyStep, error) {
	if _, ok := r.reconciler.(Finalizer); !ok {
		return resource, nil
	}
	if resource.GetDeletionTimestamp().IsZero() {
