...
import (
	...
	mystep "github.com/tektoncd/pipeline/pkg/client/injection/informers/pipeline/v1beta1/mystep"
	zap "go.uber.org/zap"
...
const (
	defaultControllerAgentName = "mystep-controller"
	defaultFinalizerName       = "mysteps.tekton.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	mystepInformer := mystep.Get(ctx)

	lister := mystepInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "tekton.dev.MyStep"),
	)
