...
type StepInterface interface {
	Create(ctx context.Context, step *steps.Step, opts v1.CreateOptions) (*steps.Step, error)
	Update(ctx context.Context, step *steps.Step, opts v1.UpdateOptions) (*steps.Step, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*steps.Step, error)
	List(ctx context.Context, opts v1.ListOptions) (*steps.StepList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *steps.Step, err error)
	StepExpansion
}
...
func newSteps(c *TektonStepsClient, namespace string) *steps {
	return &steps{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *steps) Get(ctx context.Context, name string, options v1.GetOptions) (result *steps.Step, err error) {
	result = &steps.Step{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("steps").
...
func (c *steps) List(ctx context.Context, opts v1.ListOptions) (result *steps.StepList, err error) {
...
func (c *steps) Create(ctx context.Context, step *steps.Step, opts v1.CreateOptions) (result *steps.Step, err error) {
	result = &steps.Step{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("steps").
...
func (c *steps) Update(ctx context.Context, step *steps.Step, opts v1.UpdateOptions) (result *steps.Step, err error) {
	result = &steps.Step{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("steps").
...
func (c *steps) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *steps.Step, err error) {
	result = &steps.Step{}
